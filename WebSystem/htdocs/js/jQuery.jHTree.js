...
(function ($) {
    $.widget("jHtree.jHTree", {
        ...
        _createNode: function (node, parentLiNode) {
            ...
            if (!isTreemainLi) {
                beforeDiv = '<div class="before">'+
                                '<div class="funcbtnb ui-state-default ui-corner-all" title="Level Focus" data-func="focus">'+
                                    '<span class="ui-icon ui-icon-zoomin"></span>'+
                                '</div>'+
                            '</div>';
                afterDiv = '<div class="after">'+
                                '<div class="funcbtna ui-state-default ui-corner-all" title="collapse" data-func="clps">'+
                                    '<span class="ui-icon ui-icon-triangle-1-n"></span>'+
                                '</div>'+
                            '</div>';
            }

            var nodeLiElements = '<li id="' + node.id + '" class="tnode" >' +
                                    beforeDiv + 
                                    '<div class="trcont"> ' + // ondrop="drop(event)" ondragover="allowDrop(event)"
                                        '<div class="ui-widget-header ui-corner-tl ui-corner-tr">' + node.head + '</div>' +
